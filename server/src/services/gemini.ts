...
export async function estimateTaskDuration(input: EstimateInput): Promise<EstimateResult> {
  ...
  if (typeof parsed.estimatedHours !== 'number' || typeof parsed.reasoning !== 'string') {
